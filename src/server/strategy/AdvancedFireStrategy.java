 ...
 * @author: Guo Weifeng
 * @version: 1.0
 * @create: 2020/6/16 9:50
 */
public class AdvancedFireStrategy implements FireStrategy{
    ...
    public void fire(Tank tank) {
        ...
        for (Direction direction : directions) {
            tankFrame.addGameObject(new Bullet(bulletX, bulletY, direction, tank.getTankGroup()));
